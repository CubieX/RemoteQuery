...
import org.springframework.web.util.Assert;
...
class HtmlCharacterEntityReferences {
   ...
   private static final String PROPERTIES_FILE = "HtmlCharacterEntityReferencesForIPboard.properties"; //only escapes what IPboard decimally escapes for password field
